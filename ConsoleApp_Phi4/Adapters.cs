...
namespace Microsoft.ML.OnnxRuntimeGenAI
{
    ...
    /// </summary>
    public class Adapters1 : SafeHandle
    {
        /// <summary>
        ...
        public Adapters1(Model1 model) : base(IntPtr.Zero, true)
        {
            Result1.VerifySuccess(NativeMethods.OgaCreateAdapters(model.Handle, out handle));
        }
        ...
        {
            Result1.VerifySuccess(NativeMethods.OgaLoadAdapter(handle,
        ...
        {
            Result1.VerifySuccess(NativeMethods.OgaUnloadAdapter(handle, StringUtils.ToUtf8(adapterName)));
        }
