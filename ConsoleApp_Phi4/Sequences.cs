...
{
    public class Sequences1 : IDisposable
    {
        private IntPtr _sequencesHandle;
        private bool _disposed = false;
        private ulong _numSequences;

        internal Sequences1(IntPtr sequencesHandle)
        {
        ...
        public void Append(int token, ulong sequenceIndex)
        {
            ...
            Result1.VerifySuccess(NativeMethods.OgaAppendTokenToSequence(token, _sequencesHandle, (UIntPtr)sequenceIndex));
        }
